...
from . views import ListVacancies, CreateVacancie, UpdateVacancie, DeleteVacancie, DetailVacancie, DetailApplicant
...
urlpatterns = [
    ...
    path('detalhes-candiato/<int:pk>/', DetailApplicant.as_view(), name="detail-applicant"),
]
